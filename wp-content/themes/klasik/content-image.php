    	...
    	<div class="articlecontainer">
            <div class="entry-image">
                ...
                <div class="entry-utility">
                    ...
                    <div class="category"><?php _e('in','klasik'); ?> <?php the_category(', '); ?></div>  <span class="text-sep text-sep-category">/</span>
                    <div class="comment"><?php comments_popup_link(__('No Comments', 'klasik'), __('1 Comments', 'klasik'), __('% Comments', 'klasik')); ?></div>
                    <div class="clear"></div>  
                </div>  
