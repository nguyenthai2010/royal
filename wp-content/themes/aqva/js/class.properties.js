...
var properties = (function() {
	...
	function create(array, type, firsttime){
		...
		var extMobile = DetectIphoneOrIpod() ? 'mobile':'';
		// process floor
		var n = get_floor_number(settingRoom.floor_current);
		var strMap = '';
		if (n == 3 && type == 0){ // floor 3 :: suite-apartments
			strMap = imgMain + '<map name="Map"><area shape="rect" coords="18,171,76,199" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[2] + '\')" onClick="properties.changeURL(\'' + array[2] + '\')"><area shape="rect" coords="87,157,141,199" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[1] + '\')" onClick="properties.changeURL(\'' + array[1] + '\')"><area shape="poly" coords="333,71,329,114,384,121,390,78" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[0] + '\')" onClick="properties.changeURL(\'' + array[0] + '\')"></map>';
		} 
		else if (n == 2 && type == 3){
			strMap = imgMain + '<map name="Map"><area class="201" shape="poly" coords="53,14,55,113,105,113,106,51,125,49,125,17" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[1] + '\')" onClick="properties.changeURL(\'' + array[1] + '\')"><area class="202" shape="poly" coords="212,18,211,51,131,50,128,16" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[2] + '\')" onClick="properties.changeURL(\'' + array[2] + '\')"><area class="203" shape="poly" coords="249,17,249,48,323,49,323,20" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[3] + '\')" onClick="properties.changeURL(\'' + array[3] + '\')"><area class="204" shape="poly" coords="400,22,399,62,354,63,352,52,329,51,328,20" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[4] + '\')" onClick="properties.changeURL(\'' + array[4] + '\')"><area class="205" shape="rect" coords="354,64,398,121" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[5] + '\')" onClick="properties.changeURL(\'' + array[5] + '\')"></map>';
		} 		
		else if (type == 2){
			strMap = imgMain + '<map name="Map"><area shape="rect" coords="256,48,324,95" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[0] + '\')" onClick="properties.changeURL(\'' + array[0] + '\')"><area shape="poly" coords="225,90,226,145,280,145,280,94,255,94,255,91" href="javascript:void(0);" onMouseOver'+extMobile+'="properties.hover(\'properties_' + array[1] + '\')" onClick="properties.changeURL(\'' + array[1] + '\')"></map>';
		}
